...
import br.com.alura.microservice.fornecedor.model.OrderKafka;
...
public class KafkaConfiguration {
	...
	public ConsumerFactory<String, OrderKafka> orderConsumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
				new JsonDeserializer<>(OrderKafka.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, OrderKafka> userKafkaListenerFactory() {
